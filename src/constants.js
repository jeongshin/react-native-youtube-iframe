...
export const PLAYER_ERROR_NAMES = {
  ...
  EMBED_NOT_ALLOWED_101: 'embed_not_allowed_101',
  EMBED_NOT_ALLOWED_150: 'embed_not_allowed_150',
};
...
export const PLAYER_ERROR = {
  ...
  101: PLAYER_ERROR_NAMES.EMBED_NOT_ALLOWED_101,
  150: PLAYER_ERROR_NAMES.EMBED_NOT_ALLOWED_150,
};
